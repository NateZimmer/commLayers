...
var encodeUnsigned = function(buffer, value, length) {
  var fixVal = value>>>0; // Javscript cast the value to unsigned. 	
  buffer.buffer.writeUIntBE(fixVal, buffer.offset, length, true);
...
var multiCharsetCharacterstringDecode = function(buffer, offset, maxLength, encoding, length) {
  ...
  return {
    value: decode16BE(buffer.toString(nodeEncoding, offset, offset + length)),
    len: length + 1
  };
};
